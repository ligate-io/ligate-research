...
\textbf{Ligate Labs Research, Working Paper v0.5}
...
\item
  ...
  Appendix B recap.
\item
  v0.5: prose pass on the high-visibility sections (Abstract, §1.1-1.6,
  §5.1, §5.5, §6.1, §10, §11 opener) - reduced hedging filler, varied
  sentence rhythm, cut bulleted-claim density where flowing prose
  worked, added explicit author voice. Technical content unchanged;
  specifications, theorems, definitions, and numerical claims preserved
  verbatim.
\end{itemize}
...
premium of \(4\times\) to \(10\times\) over equivalent pure-stake
chains.
